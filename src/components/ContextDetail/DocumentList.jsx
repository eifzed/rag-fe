    ...
    <ErrorBoundary>
      <div className="mt-6">
        ...
        <div className="flex items-center">
          <span className="text-lg font-medium text-gray-700 mr-4">Documents</span>
          <div className="relative inline-block">
            ...
            {showTooltip && (
              <div className="absolute z-10 w-64 px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700 bottom-full left-1/2 transform -translate-x-1/2 -translate-y-2">
                Upload up to {MAX_DOCUMENTS} documents to be integrated with this context. Only documents with status SUCCESS is included when chatting with this context
        ...
        {[...Array(emptySlots)].map((_, index) => (
          <div key={`empty-${index}`} className="flex justify-between items-center bg-gray-100 rounded-lg p-4 mb-3 text-gray-400">
