    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                Your <span className="text-indigo-600">Smart</span> Knowledge Assistant
              </h1>
              <p className="mt-4 text-lg text-gray-500 sm:text-xl">
                Transform your documents into interactive conversations. Ask questions, get instant answers, and manage your knowledge with ease.
              </p>
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-3">
            <div className="p-6 transition-all duration-300 hover:shadow-md rounded-xl text-center">
              <div className="flex justify-center mb-6">
                <img src={smartSearchIcon} alt="Smart Search" className="w-16 h-16" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900">Smart Search</h3>
              <p className="mt-3 text-gray-500">
                Find exactly what you need with natural language questions. No more endless scrolling through documents.
              </p>
            </div>
            <div className="p-6 transition-all duration-300 hover:shadow-md rounded-xl text-center">
              <div className="flex justify-center mb-6">
                <img src={chatIcon} alt="Interactive Chat" className="w-16 h-16" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900">Interactive Chat</h3>
              <p className="mt-3 text-gray-500">
                Have natural conversations with your documents. Get instant, accurate answers from your knowledge base.
              </p>
            </div>
            <div className="p-6 transition-all duration-300 hover:shadow-md rounded-xl text-center">
              <div className="flex justify-center mb-6">
                <img src={organizationIcon} alt="Easy Organization" className="w-16 h-16" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900">Easy Organization</h3>
              <p className="mt-3 text-gray-500">
                Keep your information organized and accessible. Create custom knowledge bases for different topics or projects.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="py-16 relative overflow-hidden">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-1 bg-indigo-200 -z-5" style={{ top: '140px' }}></div>
          <div className="hidden md:block absolute left-1/3 h-3 w-3 transform rotate-45 border-t-0 border-l-0 border-r-2 border-b-2 border-indigo-400" style={{ top: '138px', left: 'calc(33.3% - 8px)' }}></div>
          <div className="hidden md:block absolute left-2/3 h-3 w-3 transform rotate-45 border-t-0 border-l-0 border-r-2 border-b-2 border-indigo-400" style={{ top: '138px', left: 'calc(66.6% - 8px)' }}></div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 relative">
            <div className="text-center relative">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Create a Context</h3>
              <p className="mt-3 text-gray-600">
                Create a context that represents a group of knowledge to organize your information.
              </p>
            </div>
            <div className="text-center relative">
              <div className="w-16 h-16 mx-auto bg-indigo-600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Add Your Documents</h3>
              <p className="mt-3 text-gray-600">
                Upload or connect your documents to build your knowledge base quickly and easily.
              </p>
            </div>
            <div className="text-center relative">
              <div className="w-16 h-16 mx-auto bg-indigo-600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-6 shadow-md">
              ...
              <p className="mt-3 text-gray-600">
                Ask questions naturally and get accurate answers from your knowledge base instantly.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-2xl font-bold text-gray-900">Fazrin Adinugraha</h3>
